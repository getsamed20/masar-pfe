    ...
    if ($password !== $confirmPassword) {
        ...
        if (mysqli_num_rows($check_email) === 0 && mysqli_num_rows($check_users) === 0 && $_FILES['commercial_register']['error'] == 0 && $file_type == "pdf") {
            if (move_uploaded_file($_FILES["commercial_register"]["tmp_name"], $target_file)) {
                ...
                $insert_pending = mysqli_query($conn, "INSERT INTO pending_accounts (name, email, password, unique_identifier, commercial_register, role) 
                    VALUES ('$startup_name', '$email', '$hashed_password', '$unique_identifier', '$commercial_register', 'startup')");
...
<div class="container mt-5">
    <div class="card p-4 shadow">
        <h2 class="text-center mb-4">Startup Sign-Up</h2>
        ...
        <form id="signupForm" method="POST" enctype="multipart/form-data">
            ...
            <div id="step1">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="commercial_register" accept=".pdf" class="form-control" >
                </div>
